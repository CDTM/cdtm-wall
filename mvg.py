...
departure_url = "https://www.mvg.de/fahrinfo/api/departure/{id}?footway={walking_distance}"
...
def get_departures(station_id, walking_distance=0):
    ...
    url = departure_url.format(id=str(station_id), walking_distance=walking_distance)
